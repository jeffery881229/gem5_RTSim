...
int main(){
    ...
    FILE *fp = fopen("data_set/SVHN/svhn_img0_224x224.bin", "rb");
    /*
    data_set/CIFAR-10/cifar10_img0_224x224.bin
    data_set/ImageNet_ILSVRC-2012/ILSVRC2012_val_00000024_224x224.bin
    data_set/Oxford_102_Flower/flower_img0_224x224.bin
